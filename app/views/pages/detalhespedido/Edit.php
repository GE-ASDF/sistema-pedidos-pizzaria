                ...
                <div class="row">
                   <div class="form-group col-md">
                    ...
                    <div class="form-group col-md">
                        ...
                        <input type="hidden" value="<?php echo $CodigoPedido ?>" name="CodigoPedido" id="CodigoPedido" class="form-control">
                    </div>
                </div>
                <div class="row mt-4">
    ...
    <div class="mt-4">
        <table class="table table-dark table-striped">
               ...
               <?php if($detalhes):?>
                <?php foreach($detalhes as $detalhe): ?>
                    <tr class="text-center">
                        ...
                        <td>
                            <form action="<?php echo URL_BASE ?>detalhespedido/itemApagar">
                                <input type="hidden" name="CodigoDetalhe" value="<?php echo $detalhe->CodigoDetalhe ?>">
                                <input type="hidden" name="CodigoPedido" value="<?php echo $CodigoPedido ?>">
            ...
            <tfoot>
                <tr>
                    <td colspan="5">
                        <form action="detalhespedido/finalizar" method="POST">
                            <input type="hidden" name="CodigoPedido" value="<?php echo $CodigoPedido ?>">
                            <div class="form-group d-flex flex-wrap">
                                <div class="form-group mx-2">
                                    <label for="">Tipo de pagamento</label>
                                    <select <?php echo $pedido->Finalizado && $pedido->PedidoPronto ? "disabled":""?> class="form-select" name="CodigoTipoPagamento" id="CodigoTipoPagamento">
                                        <option value="-1">Escolher...</option>
                                        <option <?php echo $pedido->Finalizado == 1 ? "selected":"" ?> value="1">Dinheiro</option>
                                        <option <?php echo $pedido->Finalizado == 2 ? "selected":"" ?> value="2">Crédito</option>
                                        <option <?php echo $pedido->Finalizado == 3 ? "selected":"" ?> value="3">Débito</option>
                                        <option <?php echo $pedido->Finalizado == 4 ? "selected":"" ?> value="4">PIX</option>
                                    </select>
                                </div>
                                 <div class="form-group mx-2">
                                    <label for="ValorPago">Valor pago</label>
                                    <input <?php echo $pedido->Finalizado && $pedido->PedidoPronto ? "readonly":""?> value="<?php echo number_format($pedido->ValorPago, 2) ?>" type="text" name="ValorPago" class="form-control">
                                </div>
                                ...
                                <div class="form-group mx-2">
                                    ...
                                    <input value="<?php echo number_format($pedido->ValorTroco, 2) ?>" <?php echo $pedido->Finalizado && $pedido->PedidoPronto ? "readonly":""?> type="text" name="ValorTroco" class="form-control">
                                </div>
                                <div class="form-group mx-2">
                                ...
                                <button <?php echo $pedido->Finalizado == 1 ? "disabled":"" ?> class="btn btn-danger m-2 "><?php echo $pedido->Finalizado == 1 ? "FINALIZADO":"FINALIZAR" ?></button>
                            </div>                            
                        </form>
                    </td>
                </tr>
